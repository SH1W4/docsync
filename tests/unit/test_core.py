...
class TestDocSyncCore:
    ...
    @pytest.mark.asyncio
    async def test_sync_operation(self, temp_dir: Path, sample_config: dict, sample_files: dict):
    ...
    def test_report_generation_invalid_template(self, temp_dir: Path, sample_config: dict):
    ...
    def test_large_file_handling(self, temp_dir: Path, sample_config: dict, performance_config: dict):
    ...
    def test_path_traversal_protection(self, temp_dir: Path, sample_config: dict, security_test_data: dict):
...
class TestErrorHandling:
    ...
    def test_error_chaining(self):
        ...
        chained_error = DocSyncError("Wrapped error") from original_error
...
class TestDocSyncIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_sync_workflow(self, temp_dir: Path, sample_config: dict, sample_files: dict):
